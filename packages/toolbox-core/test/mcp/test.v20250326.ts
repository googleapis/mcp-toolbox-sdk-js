  ...
  describe('toolInvoke', () => {
    ...
    it('should reject non-empty secureArguments', async () => {
      await expect(
        ...
        "Secure parameters are not supported in MCP protocol version '2025-03-26'. Please use protocol version '2026-07-28' or newer.",
      );
    });
    ...
    it('should not warn if using HTTPS', async () => {
      ...
      const httpsTransport = new McpHttpTransportV20250326(
